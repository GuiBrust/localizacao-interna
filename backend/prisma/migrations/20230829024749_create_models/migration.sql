...
-- AddForeignKey
ALTER TABLE "plantas_baixas" ADD CONSTRAINT "plantas_baixas_andar_id_fkey" FOREIGN KEY ("andar_id") REFERENCES "andares"("id") ON DELETE SET NULL ON UPDATE CASCADE;
